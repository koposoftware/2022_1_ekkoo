...
<body class="app">
	  ...
	  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
					        ...
					        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        ...
							        <li class="submenu-item"><a class="submenu-link" href="${pageContext.request.contextPath }/product/main">상품등록</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->
	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<h1 class="app-page-title">Main Page</h1>
						...
						<div class="row gx-5 gy-3"> 
							<div class="col-sm-7">
								<div class="app-card-body p-3 p-lg-4">
									<h3 class="mb-3 text-primary">하나원큐레이터 관리자 PAGE</h3>
									<h5 class="mb-3 text-secondary">안녕하세요 관리자님!</h5>
							...
							<div class="col-sm-5 text-center text-sm-left">
								<div class="app-card-body p-3 p-lg-44">
									<img
										src="${pageContext.request.contextPath}/resources/images/man-with-laptop-light.png"
				...
				<div class="row g-4 mb-4">
					<div class="col-12 col-lg-4">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								<h4 class="stats-type mb-1">회원 접속자 수</h4>
  ...
  <path fill-rule="evenodd"
					...
					<div class="col-12 col-lg-4">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								<h4 class="stats-type mb-1">총 회원자 수</h4>
					...
					<div class="col-12 col-lg-4">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								<h4 class="stats-type mb-1">신규 가입자 수</h4>
				...
				<div class="row g-4 mt-3 mb-4">
					<div class="col-12 col-lg-6">
						<div
							class="app-card app-card-basic text-white d-flex flex-column align-items-start shadow-sm"
							style="background-color: #21af92">
  ...
  <path fill-rule="evenodd"
									...
									<!--//col-->
									<div class="col-auto">
										<h4 class="app-card-title text-white">회원 관리</h4>
									</div>
									<!--//col-->
								</div>
								<!--//row-->
							...
							<div class="app-card-body px-4">
								...
								<div class="intro">하나원큐레이터의 회원 분석과 회원 관리</div>
							</div>
							<!--//app-card-body-->
							<div class="app-card-footer p-4 mt-auto">
								<a class="btn app-btn-secondary" href="#">조회하기</a>
							</div>
							<!--//app-card-footer-->
						</div>
						<!--//app-card-->
  ...
  <path fill-rule="evenodd"
									...
									<!--//col-->
									<div class="col-auto">
										<h4 class="app-card-title text-white">상품 관리</h4>
									</div>
									<!--//col-->
								</div>
								<!--//row-->
							...
							<div class="app-card-body px-4">
								...
								<div class="intro">하나원큐레이터의 상품 관리</div>
							</div>
							<!--//app-card-body-->
							<div class="app-card-footer p-4 mt-auto">
								<a class="btn app-btn-secondary" href="#">조회하기</a>
