...
<body class="app">
			...
			<div class="sidepanel-inner d-flex flex-column">
				...
				<div class="app-branding">
					<a class="app-logo" href="index.jsp"><img
						...
						src="${pageContext.request.contextPath }/resources/images/hanaLogo.png"
						alt="logo"><span class="logo-text">하나원큐레이터</span></a>
				</div>
				<!--//app-branding-->
  ...
  <path fill-rule="evenodd"
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link"
							href="${pageContext.request.contextPath }/product/main"> <span
								class="nav-icon"> <svg width="1em" height="1em"
  ...
  <circle cx="3.5" cy="10.5" r=".5" />
							...
							</span> <span class="nav-link-text">상품 관리</span>
						</a> <!--//nav-link-->
						</li>
						<!--//nav-item-->
						<li class="nav-item">
  ...
  <path
	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<h1 class="app-page-title">하나원큐레이터 회원 조회</h1>

				<div class="row g-4 mb-4">
					<div class="col-6 col-lg-4">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								<h6 class="text-primary">총 회원자 수</h6>
								<div class="stats-figure">${allMemberCnt}</div>
					...
					<div class="col-6 col-lg-4">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								<h6 class="text-primary">저번주 신규 가입자 수</h6>
								<div class="stats-figure">${newMemberCnt}</div>
					...
					<div class="col-6 col-lg-4">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								<h6 class="text-primary">휴면 회원 수</h6>
						...
						<div class="modal-dialog modal-lg" role="document">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h5 class="modal-title" id="exampleModalLabel3">하나원큐레이터 메세지
										전송</h5>
								...
								<div class="modal-body">
									...
									<div class="row">
										<div class="col mb-3">
											<label for="nameLarge" class="form-label">내용을 입력해주세요</label>
											<br>
											<textarea id="nameLarge" rows="20" class="w-100"
				...
				<div class="row g-4 mb-4">
					<div class="col-12 col-lg-12" style="text-align: right;">
						<button type="button" class="btn btn-warning" style="margin-right: 20px;"
								data-bs-toggle="modal" data-bs-target="#messageModal" id="messageModalBtn">
								메세지 전송</button>
					</div>
					<div class="col-12 col-lg-12 mt-0">
						<div class="app-card app-card-chart h-100 shadow-sm m-3 p-3">
							<div class="table-responsive">
								<table id="data_list"
									...
									<thead class="table-light">
										<tr>
											<th class="cell">선택</th>
											<th class="cell">아이디</th>
											<th class="cell">성명</th>
											<th class="cell">성별</th>
											<!-- <th class="cell">연령대</th> -->
											<th class="cell">전화번호</th>
											<th class="cell">이메일주소</th>
											<th class="cell">가입일</th>
											<th class="cell">최근접속일</th>
											<th class="cell">회원타입</th>
										</tr>
									</thead>
									<tbody>
									</tbody>
	...
	$("#messageModalBtn").click(function(){
			...
			$('input:checkbox[name=message]:checked').each(function() { 
				...
				$("#text_tel").html('<input type="hidden" name="telephone" value="'+this.value+'">')
			})
	});
	...
	<script>
		$("#data_list")
				.DataTable(
						{
							ajax : {
								url : '${pageContext.request.contextPath}/selectallmember.json',
								dataSrc : ''
							},
							"responsive" : true,
							columns : [
									{
										...
										"render" : function(data, type, full,
												meta) {
											data = '<input type="checkbox" name="message" id="'
	                                 		+ data +'" value = "'+data+'">';
											return data
										}
									},
									...
									},
									{
										...
										"render" : function(data, type, full,
												meta) {
											var data1 = data.split('@')[0].length-2; // AB***@gamil.com
											   return data.replace(new RegExp('.(?=.{0,' + data1 + '}@)', 'g'), '*');
										}
									},
									{
										targets : 6,
									...
									},
									{
										...
										"render" : function(data, type, full,
												meta) {
											if (data === 'U') {
												data = '<button class="btn btn-primary" style="padding:5px 10px;"  type="button">일반회원</button>';
											} else {
												data = '<button class="btn btn-warning" style="padding:5px 10px;"  type="button">휴면회원</button>';
											}
											return data
										}
									}],
