	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<h1 class="app-page-title">하나원큐레이터 회원 관리</h1>
						...
						<div class="app-card-body p-4">
							<div class="row gx-5 gy-3">
								<div class="col-12 col-lg-9">
									...
									<div>
										<h5 class="text-primary">전체 회원 조회</h5>
										<h6>모든 회원 목록, 하나원큐레이터 회원 분석 내용을 확인하실 수 있습니다.</h6>
									</div>
								</div>
								<!--//col-->
								<div class="col-12 col-lg-3">
									<a class="btn app-btn-primary mt-2 p-3"
										href="${pageContext.request.contextPath }/member/selectAll"><svg
  ...
  <path fill-rule="evenodd"
				...
				<!--//app-card-->
					...
					<div class="col-6 col-lg-4">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								<h4 class="stats-type mb-1">저번주 신규 가입자 수</h4>
					...
					<div class="col-6 col-lg-4">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								<h4 class="stats-type mb-1">휴먼 회원 수</h4>
								<div class="stats-figure">${dormantCnt }</div>
								<div class="stats-meta">New</div>
							</div>
							<!--//app-card-body-->
							<a class="app-card-link-mask" href="#"></a>
				...
				<div class="row g-4 mb-4">
					<div class="col-12 col-lg-6">
						<div class="app-card app-card-chart h-100 shadow-sm">
							<div class="app-card-header p-3 border-0">
								<h4 class="app-card-title">회원 성비</h4>
							</div>
							<!--//app-card-header-->
							<div class="app-card-body p-4">
								<div class="chart-container text-center">
									<div style="margin-left: 50px;" id="genderChart"></div>
								</div>
							</div>
							<!--//app-card-body-->
						</div>
					...
					<div class="col-12 col-lg-6">
						<div class="app-card app-card-chart h-100 shadow-sm">
							<div class="app-card-header p-3 border-0">
								<h4 class="app-card-title">회원 연령대</h4>
							</div>
							<!--//app-card-header-->
							<div class="app-card-body p-4">
	...
	<script type="text/javascript">
		...
		var chart = new ApexCharts(document.querySelector("#genderChart"),
				options);
		chart.render();
	</script>
	<script type="text/javascript">
		//10대회원 수
		var age10 = ${ageMap['A10']};
		//20대회원 수
		var age20 = ${ageMap['A20']};
		//30대회원 수
		var age30 = ${ageMap['A30']};
		//40대회원 수
		var age40 = ${ageMap['A40']};
		//50대회원 수
		var age50 = ${ageMap['A50']};
		//60대회원 수
		var age60 = ${ageMap['A60']};
		//70대회원 수
		var age70 = ${ageMap['A70']};
		//80대회원 수
		var age80 = ${ageMap['A80']};
		//기타회원 수
		var etc = ${ageMap['ETC']};
		...
		var options2 = {
			series : [ {
				name : '회원수',
				data : [ age10, age20, age30, age40, age50, age60, age70,
						age80, etc ]
			} ],
			chart : {
				height : 350,
		...
		var chart2 = new ApexCharts(document.querySelector("#ageChart"),
				options2);
		chart2.render();
	</script>
