...
<body class="app">
  ...
  <path fill-rule="evenodd"
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link active" href="${pageContext.request.contextPath }/product/main"> <span class="nav-icon">
									<svg width="1em" height="1em" viewBox="0 0 16 16"
					...
					<div class="col-10 m-auto mt-5">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								<h3 class="mt-3" style="color: #08a294;">메세지 전송이 완료되었습니다</h3>
								<img class="m-3" style="width: 15%; height: 15%;" alt="" src="${pageContext.request.contextPath }/resources/images/message.gif">
							</div>
