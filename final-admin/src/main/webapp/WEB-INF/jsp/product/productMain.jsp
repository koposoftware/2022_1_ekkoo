	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				...
				<h1 class="app-page-title">하나원큐레이터 상품 등록</h1>

				<div class="row g-4 mb-4">
					<div class="col-6 col-lg-6">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								<h3 class="m-3" style="color: #08a294;">연금 보험</h3>
								<img class="m-3" style="width: 15%; height: 15%;" alt="" src="${pageContext.request.contextPath }/resources/images/icon/retirement.png">
								<h6 class="m-3">새로운 연금 보험 등록하기</h6>
							</div>
							<!--//app-card-body-->
							<a class="app-card-link-mask" href="${pageContext.request.contextPath }/product/registerPension"></a>
						</div>
						<!--//app-card-->
					</div>
					...
					<div class="col-6 col-lg-6">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								<h3 class="m-3" style="color: #08a294;">예·적금</h3>
								<img class="m-3" style="width: 15%; height: 15%;" alt="" src="${pageContext.request.contextPath }/resources/images/icon/book.png">
								<h6 class="m-3">새로운 예·적금 등록하기</h6>
							</div>
							<!--//app-card-body-->
					...
					<div class="col-6 col-lg-6">
						<div class="app-card app-card-stat shadow-sm h-100">
							<div class="app-card-body p-3 p-lg-4">
								<h3 class="m-3" style="color: #08a294;">카드</h3>
								<img class="m-3" style="width: 15%; height: 15%;" alt="" src="${pageContext.request.contextPath }/resources/images/icon/credit.png">
								<h6 class="m-3">새로운 카드 등록하기</h6>
							</div>
							<!--//app-card-body-->
							<a class="app-card-link-mask" href="#"></a>
						</div>
					...
					<div class="col-6 col-lg-6">
						<div class="app-card app-card-stat shadow-sm h-100" style=" background-color: #ecf1ef;">
							<div class="app-card-body p-3 p-lg-4" style="text-align:right;">
								<h6 class="m-5" style="padding-top:150px">HANA1QURATOR</h6>
							</div> 
							<!--//app-card-body-->
						</div>
						<!--//app-card-->
