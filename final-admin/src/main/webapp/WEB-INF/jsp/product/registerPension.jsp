...
<body class="app">
  ...
  <path fill-rule="evenodd"
	  ...
	  <path
							...
							</span> <span class="nav-link-text">상품관리</span> <span
							...
							<div id="submenu-1" class="collapse submenu submenu-1"
								...
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link"
										href="notifications.html">상품조회</a></li>
									<li class="submenu-item"><a class="submenu-link active"
										href="${pageContext.request.contextPath }/product/main">상품등록</a></li>
								</ul>
							</div>
						</li>
						<!--//nav-item-->
						...
						<div class="col-12 col-lg-12 app-card bg-white">
							...
							<div class="table-responsive  mb-5 pb-5">
								<table class="table table-borderd"
									...
									<tr>
										<td class="p-3"
											style="width: 20%; background-color: #f2fcf5; color: black;"><h6>상품
												종류</h6></td>
										...
										<td class="p-3" 
											style="width: 30%; background-color: #f2fcf5; color: black; border-left: 3px solid; border-left-color: #08a294;"><h6>상품
												유형</h6></td>
										<td class="d-flex p-3">
											<div class="form-check">
												<input class="form-check-input" type="radio"
													name="pensionType" value="01" checked /> <label
													class="form-check-label" for="pensionType"><h6>일반저축은행</h6></label>
											</div>
											<div class="form-check">
