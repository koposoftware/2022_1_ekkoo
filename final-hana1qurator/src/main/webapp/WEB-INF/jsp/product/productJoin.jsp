						...
						<div class="accordion mt-3" id="accordionExample">
							<form name="joinOpenBankingForm">
								...
								<div class="col-12 col-lg-10 m-auto pt-5 pb-3 text-center text-black">
									...
									제공해야 합니다. <br>본인은 약관 및 상품설명서의 주요 내용에 대하여 <span style="color:#ff328b ">충분히 이해하였습니다.<span></div>
								...
								<div class="mt-5 mb-5" style="text-align: center;">
									<input type="button" class="btn btn-primary" value="동의합니다" style="padding-left: 100px; padding-right: 100px;"
