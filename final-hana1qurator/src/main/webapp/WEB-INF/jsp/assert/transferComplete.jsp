...
<body class="app">
	...
	<div class="container-fluid page-header py-5 mb-5">
		<div class="container py-5">
			<h1 class="display-3 text-white mb-3 animated slideInDown">자금
				하나로 모으기</h1>
	...
	<div class="container-xxl py-5">
		<div class="container">
			<div class="row g-4">
				...
				<div class="col-md-12 col-lg-12 mb-5 pb-2 wow fadeInUp"
					data-wow-delay="0.1s">
					<div class="service-item rounded overflow-hidden">
						<div class="row">
							<div class="col-lg-5 mt-5 text-center">
								<img alt="" style="width: 60%; height: 90%;"
									src="${pageContext.request.contextPath}/resources/img/gif/done.gif">
							</div>
							<div class="col-lg-7 mt-5">
								<div class="position-relative p-4 " style="color: black;">
									<h2 class="text-primary">이체 완료</h2>
									<p class="text-secondary ">이체를 완료하였습니다. 하나원큐레이터를 이용해주셔서
										감사합니다.</p>
									<a href="${pageContext.request.contextPath }/"
										class="btn btn-secondary mt-5 " style="margin-right: 10px;">메인페이지로
										이동</a> <a
										href="${pageContext.request.contextPath }/assert/SelectMyAssert"
										class="mt-5  btn btn-primary">잔액 확인하기</a>
								</div>
							</div>
						</div>
							...
							if (checked1 && checked2) {
								...
								$
										.ajax({
											...
											success : function() {
												location.href = "${pageContext.request.contextPath}/product/subscription/"
														+ productNo;
											},
											error : function() {
												alert('실패')
