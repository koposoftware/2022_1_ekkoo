...
<body class="app">
	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4"
			...
			<div class="container-xl">
				...
				<%-- 파일 업로드	<form action="${pageContext.request.contextPath}/uploadfile"
				...
				<form id="aloneForm"
					...
					<div class="m-0 p-0" style="text-align: right;">
						<a
							...
							부부설계 하러가기<i class='bx bx-chevron-right-square'></i>
						</a>
					</div>
					...
					<div class="row g-4 settings-section mt-2 mb-3">
										...
										<div class="modal-body">
											...
											<div class="mb-4">
												<h5 class="text-center">${loginVO.name }님의
													홈택스 연동 결과, 평균 월 생활비는 <span id="livingExpenceSpan"
											...
											<div class="pt-4 ps-2">
												...
												<p class="text-left m-0">-현 생활비는 홈택스 신용카드,직불카드,현금영수증 연간
						...
						<div class="col-12 col-md-4">
							...
							<div class="section-intro">
								<p style="color: grey;">- 예상되는 은퇴 후 월 생활비를 입력해주세요.</p>
							</div>
							<div class="section-intro">
								<p style="color: grey;">- 현 생활비의 70%가 은퇴 후 월 적정생활비입니다.</p>
							</div>
							<div class="section-intro">
								<p style="color: grey;">
						...
						<div class="col-12 col-md-8">
							<div class="card app-card app-card-settings shadow-sm p-4 mt-3"
								...
								<div class="app-card-body" style="font-size: 17px;">
									...
									<div class="mt-3 mb-3">
										고객님의 현재 월 생활비는 <input class="border border-radius-5"
											style="width: 100px; text-align: right;" type="text"
						...
						<div style="padding-top: 50px;">
							<div class="col-auto" style="float: left;">
								<h5 style="color: #004c4c">
									<i class='bx bx-sm bx-party'></i>결혼 자금 마련
								</h5>
							</div>
							...
							<div class="col-12 col-md-8">
								<div class="card app-card app-card-settings shadow-sm p-4"
									...
									<div class="app-card-body" style="font-size: 17px;">
										...
										<div class="mb-3">
											<label for="setting-input-2">현재 보유하고 있는 주택이</label> <select
												class="border border-radius-5" name="haveHouse">
												<option value="noHoues">없</option>
												<option value="yesHouse">있</option>
											</select> <label for="setting-input-2">습니다.</label>
										</div>
									</div>
									<!--//app-card-body-->
						...
						<div class="mt-5">
							<div class="col-auto" style="float: left;">
								...
								<div class="section-intro">
									<p style="color: grey;">- 목표하는 목돈 마련 계획을 입력해주세요.</p>
								</div>
							</div>
							<div class="col-auto" style="padding-left: 1000px;">
								<div class="form-check form-switch" style="text-align: right;">
									...
									<tbody>
										<tr>
											<td style="width: 40%"><input type="text" value=""
												...
												id="incomeInput">만원 <input type="hidden"
	...
	$('#homeBtn1').click(function(){
			...
			$.ajax({
				url : 'http://130.162.132.21:8080/hometax-api/api/access'
				,method : 'post'
				,data : {
					companyCode : 'A0101',
	...
	$('#homeBtn').click(function(){
		...
		$.ajax({
		url : 'http://130.162.132.21:8080/hometax-api/api/anualHometaxInfo.json'
		,method : 'post'
		,data : {
			id :'lovehana',
			password : 'lovehana'
